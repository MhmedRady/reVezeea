...
namespace vezeeta.DBL.Migrations
{
    ...
    [Migration("20221218183440_center_entity_update")]
    partial class centerentityupdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("vezeeta.DBL.db.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("vezeeta.DBL.db.Models.Center", b =>
                {
                    b.HasOne("vezeeta.DBL.db.Models.Department", "Department")
                        .WithMany("Centers")
                        .HasForeignKey("DepartmentId");

                    b.HasOne("vezeeta.DBL.db.Models.User", "User")
                        .WithMany("Centers")
